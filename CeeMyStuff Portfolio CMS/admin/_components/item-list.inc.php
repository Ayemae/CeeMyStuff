<a href="<?show($route)?>/sections.php?task=list"><i class="fi fi-rs-angle-double-small-left"></i> back to Section List</a>

<div class="space-btwn">
    <h1>View <?=($sect['ID']>0 ? 'Section Items : '.$sect['Name'] : 'Orphaned Items');?></h1>
...
<div class="admin-table section-items">
    <ul class="table-head">
            <li>
            <? if($customOrder):?>
                Order /
