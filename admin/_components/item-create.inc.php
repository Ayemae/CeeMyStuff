...
<ul class="form-list">
    ...
    <li>
        ...
        <select name="n_sect_id" id="sect-id">
            ...
            <? foreach ($sectList AS $section) :?>
                <option value="<?show($section['ID'])?>" <?=($sectInfo['ID']===$section['ID'] ? 'selected' : null )?>>
    ...
    <li>
        ...
        <div class="chktoggle-show">
            <label for="img_upload">Upload Image (jpg, png, gif, or webp):</label>
    ...
    <?php else : ?>
        ...
        <p> - OR - </p>
        <label for="create-thumbnail"> Auto-Create Thumbnail From Item's Image (Optional):</label>
        ...
        <div class="chktoggle-show">
            ...
            <div>
                ...
                <select id="file-pres" name="file_pres">
                    ...
                    <option value="dld">Download</option>
