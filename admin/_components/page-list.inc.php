        ...
        <li class="page-box">
            ...
            <div class="chktoggle-show flex-col">
                ...
                <div class="page-options">
                    <a class="opt" href="?task=edit&id=<?show($page['ID'])?>"><i class="fi fi-rs-settings"></i> Edit Page Settings</a>
                    ...
                    <?php if ($catList) : ?>
                        ...
                        <?php foreach ($catList AS $cat) : ?>
                            <li class="cat-box" >
                                ...
                                <div class="<?=($page['Multi_Cat'] ? 'chktoggle-show' : 'flex-col')?>">
                                    <hr>
                                    <div class="flex-row cat-options">
                                        <a class="opt" href="<?show($route)?>/categories.php?task=edit&catid=<?show($cat['ID'])?>"><i class="fi fi-rs-settings-sliders"></i> Edit Settings</a>
